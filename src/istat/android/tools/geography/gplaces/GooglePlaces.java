...
public class GooglePlaces {
	...
	public PlacesList search(PlaceFilter filter) throws ClientProtocolException, URISyntaxException, IOException, JSONException, GooglePlaceException{
		http.clearExtraData();
	...
	public PlacesList nextPageSearch() throws ClientProtocolException, URISyntaxException, IOException, JSONException, GooglePlaceException{
	...
	public PlacesList getPlaceDetails(String place_id) throws ClientProtocolException, URISyntaxException, IOException, JSONException, GooglePlaceException{
		http.clearExtraData();
